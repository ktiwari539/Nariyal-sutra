...
function loadOrderOperations(){if(window.__NS_V421_ORDER_OPERATIONS__||document.querySelector('script[data-ns-order-operations]'))return;const s=document.createElement('script');s.src='assets/js/admin-v44-order-operations.js';s.dataset.nsOrderOperations='1';document.body.appendChild(s);}
function init(){setTimeout(ensure,120);window.addEventListener('nsv421:change',()=>setTimeout(ensure,20));loadOrderOperations();}
