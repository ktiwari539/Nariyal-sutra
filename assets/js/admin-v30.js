(function(){
'use strict';
const Store=window.NSV421Store,$=(s,r=document)=>r.querySelector(s),$$=(s,r=document)=>[...r.querySelectorAll(s)];if(!Store)return;
const PAGES={'about-nariyal-sutra.html':['Opening / story world hero','Five coconut journeys','Story transition','Final CTA'],'bulk-coconut-supply.html':['Bulk supply hero','Volume planning','Commercial requirements','Final CTA'],'coconut-events-hospitality.html':['Hospitality hero','Story chapter','Motion / film','Facts / proof','Enquiry CTA'],'coconut-water.html':['Coconut water hero','What customers receive','Freshness / handling','Product choices','Use cases / proof','Final CTA'],'coconut-wholesale-export.html':['Trade hero','Routes / destinations','Commercial process','Final CTA'],'direct-farm.html':['Sourcing hero','Business truth','Source proof','Sourcing chain','Final CTA'],'fresh-tender-coconut.html':['Product hero','Product story','Motion / serving','Facts / details','Order CTA'],'freshness-first.html':['Freshness hero','Water / motion story','Freshness proof','Final CTA'],'green-coconut.html':['Product hero','Product story','Motion / serving','Facts / details','Order CTA'],'gujarat-coast.html':['Coastal hero','Tide / sourcing story','Final CTA'],'people-of-nariyal-sutra.html':['Editorial stories','Ambassador / promoter rails','People story grid','Community / values','Share your story'],'south-india-groves.html':['Grove hero','Canopy story','Source proof','Final CTA'],'supplier-partnership.html':['Supplier hero','Supplier requirements','Final CTA']};
