(function(){
  ...
  addEventListener('resize',()=>{clearTimeout(enforceCinematicRunway.t);enforceCinematicRunway.t=setTimeout(enforceCinematicRunway,80);},{passive:true});
  ...
  const mo=new MutationObserver(records=>{
    ...
    if(filmTouched)setTimeout(enforceCinematicRunway,0);
  ...
  window.NS_V421_STABILIZATION={
    build:'2026-09-13-authoritative-startup-runway',
