...
function ensureApprovedMedia(s){
 ...
 s.media=[...campaign,...website,...others];s.faceMarquee=s.faceMarquee||{};s.settings=s.settings||{};
 s.faceMarquee.selectedIds=unique(Array.isArray(s.faceMarquee.selectedIds)?s.faceMarquee.selectedIds:[]);
 /* Campaign portraits remain Admin-owned Ambassador media. Do not silently inject them into
    the homepage People rail; that rail keeps its explicitly selected customer/community set. */
