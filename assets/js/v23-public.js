...
function setupWaterPlayer(){
 ...
 let fallback=$('.v23-water-fallback',win);if(!fallback){fallback=document.createElement('div');fallback.className='v23-water-fallback';fallback.innerHTML='<img class="is-active" src="https://nariyal-sutra.netlify.app/assets/images/story-coconut-hero.png" alt="Fresh tender coconut"><img src="https://nariyal-sutra.netlify.app/assets/images/story-coconut-body-cut.png" alt="Fresh coconut opening"><img src="assets/images/freshness-coconut-splash.webp" alt="Fresh coconut water pour">';win.insertBefore(fallback,video);}
 let ft=null,fi=0;
